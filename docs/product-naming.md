...
| Review unit | case, agent request, run, or review |

`LandOps` and `Workroom` remain compatibility identifiers in existing routes,
storage, permissions, and deployment settings. They are not user-facing
product names. Do not introduce them as new products or collaboration spaces.
