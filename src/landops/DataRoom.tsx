...
export function DataRoom({ records }: Props) {
  return <section className="data-room card" aria-label="Fictional company data room">
    <div className="card-head"><div><span className="eyebrow blue">BLUE RIDGE DATA ROOM</span><h3>Seed records agents can analyze</h3></div><span className="pill synthetic">ALL SYNTHETIC</span></div>
